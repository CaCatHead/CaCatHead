    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='submission_user',
                                            to=settings.AUTH_USER_MODEL, verbose_name='创建者')),
                ('problem',
                 models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='submission_problem',
                                   to='problem.problem', verbose_name='所属题目')),
                ('repository',
                 models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='submission_repository',
