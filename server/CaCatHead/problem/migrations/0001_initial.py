    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to=settings.AUTH_USER_MODEL, verbose_name='创建者')),
            ],
            options={
                'verbose_name': '题目信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('problem_type', models.CharField(choices=[('classic', 'classic'), ('interactive', 'interactive')], max_length=32, verbose_name='题目类型')),
                ('time_limit', models.IntegerField(default=1000, verbose_name='时间限制')),
                ('memory_limit', models.IntegerField(default=262144, verbose_name='内存限制')),
                ('score', models.IntegerField(default=0, verbose_name='题目总分')),
                ('testdata_count', models.IntegerField(default=0, verbose_name='用例数目')),
                ('testdata_score', models.JSONField(default=[], verbose_name='用例分数')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('problem_content', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='problem.problemcontent', verbose_name='题目描述内容')),
                ('problem_judge', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='problem.problemjudge', verbose_name='评测信息')),
            ],
            options={
                'verbose_name': '题目信息',
        ...
        migrations.AddField(
            model_name='problem',
            name='problem_info',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='problem.probleminfo', verbose_name='题目信息'),
        ),
    ]
