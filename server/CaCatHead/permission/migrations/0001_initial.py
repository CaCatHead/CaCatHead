...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('user', 'content_type', 'content_id', 'codename'),
                                               name='unique user_permission'),
        ),
        migrations.AddConstraint(
            model_name='grouppermission',
            constraint=models.UniqueConstraint(fields=('group', 'content_type', 'content_id', 'codename'),
